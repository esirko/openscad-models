...
sqrt2 = sqrt(2);
shape = [[47-dx, 0], [43-dx, -4], [41-dx, -12], [38-dx, -18], [35-dx, -21], [30-dx, -h], [0, -h], 
    [0, -h+t], [30-dx-t/sqrt2, -h+t], [35-dx-t/sqrt2, -21+t/sqrt2], [38-dx-t/sqrt2, -18+t/sqrt2], [41-dx-t, -12], [43-dx-t, 0]];

blank_space_shape = [[43,0], [41,-12], [39,-18], [34,-23], [26,-26],
    [30-dx-t/sqrt2, -h+t], [35-dx-t/sqrt2, -21+t/sqrt2], [38-dx-t/sqrt2, -18+t/sqrt2], [41-dx-t, -12], [43-dx-t, 0]];

difference() {
    union() {
        diff() cyl(r1=r0, r2=r0-4, h=1, anchor=BOTTOM, rounding2=1, $fn=fn)
...
down(h) {
    ...
    up(t+3) cyl(r=4, h=10, anchor=BOTTOM);
    up(t+13) cyl(r1=4, r2=6, h=3, rounding2=1, anchor=BOTTOM);
}
